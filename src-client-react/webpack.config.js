...
const config = { // config object
  ...
  // entry: './src-client-react/index.js', // entry file
  output: { // output
    path: path.resolve(__dirname,'..', 'build-client-react'), // ouput path
  ...
  resolve: { // These options change how modules are resolved
    ...
    alias: { // Create aliases
      images: path.resolve(__dirname, 'assets/images')  // src-client-react/assets/images alias
    }
  },
  module: {
    rules: [ // loader rules
      ...
      },
      {
        ...
        loaders: ['file-loader?context=/assets/images/&name=images/[path][name].[ext]', {  // images loader
  ...
  devServer: {
    contentBase: path.resolve(__dirname,'..', 'build-client-react'), // A directory or URL to serve HTML content from.
